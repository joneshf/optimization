...
> import P2.Morphism (incPairsDists, nearestDistance, nearestNeighbors, tour, tourDistance)
...
> direct' xs = direct (length xs) . tourDistance . tour $ xs
...
> bothDistances' fp ns = (takeBaseName fp, (tourDistance $ tour ns, nearestDistance ns))
